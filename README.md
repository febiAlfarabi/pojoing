...
It can be used for mapping regular object, post data in request body where you facing issue to put ORM object directly in a parameter, or you cannot convert to json directly, or any other problem regarding it.
